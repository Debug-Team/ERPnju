...
import main.Presentation.ManagerUI.PromotionUI.CustomerPromotionFrame.CouponInfo;
import main.Presentation.ManagerUI.PromotionUI.CustomerPromotionFrame.GiftInfo;
...
public class TotalPromotionFrame extends MainUIController{
	@FXML
	...
	public static Parent init() {
		try {
			GridPane totalPromotionFrame = FXMLLoader.load(TotalPromotionFrame.class.getResource("TotalPromotionFrameFXML.fxml"));
			return totalPromotionFrame;
		} catch (IOException e) {
...
//		});
	...
	private void sure() {
		...
		double total = Double.parseDouble(sumPriceField.getText());
		...
		TotalPromotionVO vo = new TotalPromotionVO(startTime, endTime, total, giftList, couponList);
